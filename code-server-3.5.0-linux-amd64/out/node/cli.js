...
exports.bindAddrFromAllSources = exports.readConfigFile = exports.setDefaults = exports.parse = exports.optionDescriptions = exports.OptionalString = exports.LogLevel = exports.Optional = void 0;
...
var options = {
    ...
    "install-extension": {
        type: "string[]",
        description: "Install or update a VS Code extension by id or vsix. The identifier of an extension is `${publisher}.${name}`. To install a specific version provide `@${version}`. For example: 'vscode.csharp@1.2.3'.",
    },
    "enable-proposed-api": {
        type: "string[]",
