...
var main = function (args, cliArgs, configArgs) { return __awaiter(void 0, void 0, void 0, function () {
    var envPassword, password, _a, host, port, options, _b, _c, httpServer, serverAddress, openAddress;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, util_2.open(openAddress).catch(console.error)];
            case 6:
                _d.sent();
...
function entry() {
    return __awaiter(this, void 0, void 0, function () {
        var tryParse, _a, args, cliArgs, configArgs, pipeArgs, isDir, i, fp, vscode, vscode_2;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [3 /*break*/, 9];
                case 2:
                    if (!args.version) return [3 /*break*/, 3];
                    if (args.json) {
                        console.log({
                            codeServer: version,
                            commit: commit,
                    ...
                    return [3 /*break*/, 9];
                case 3:
                    if (!process.env.VSCODE_IPC_HOOK_CLI) return [3 /*break*/, 8];
                    pipeArgs = {
                        type: "open",
                        folderURIs: [],
                    ...
                    isDir = function (path) { return __awaiter(_this, void 0, void 0, function () {
                        var st, error_2;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                    ...
                    _b.label = 4;
                case 4:
                    if (!(i < args._.length)) return [3 /*break*/, 7];
                ...
                case 7:
                    ...
                    if (pipeArgs.folderURIs.length === 0 && (!pipeArgs.fileURIs || pipeArgs.fileURIs.length === 0)) {
                        logger_1.logger.error("Please specify at least one file or folder argument");
                        process.exit(1);
                    }
                    ...
                    vscode.on("error", function (err) {
                        logger_1.logger.debug("Got error from VS Code", logger_1.field("error", err));
                    });
                    vscode.write(JSON.stringify(pipeArgs));
                    vscode.end();
                    return [3 /*break*/, 9];
                case 8:
                    if (args["list-extensions"] || args["install-extension"] || args["uninstall-extension"]) {
