...
exports.wrap = exports.WrapperProcess = exports.ipcMain = exports.IpcMain = exports.ProcessError = void 0;
...
var IpcMain = /** @class */ (function () {
    ...
    IpcMain.prototype.exit = function (error) {
...
var WrapperProcess = /** @class */ (function () {
    function WrapperProcess(currentVersion, options) {
        ...
        exports.ipcMain().onMessage(function (message) {
            switch (message.type) {
                case "relaunch":
                    logger_1.logger.info("Relaunching: " + _this.currentVersion + " -> " + message.version);
        ...
        process.on("SIGUSR1", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                logger_1.logger.info("Received SIGUSR1; hotswapping");
                this.relaunch();
                return [2 /*return*/];
            });
        }); });
    }
    WrapperProcess.prototype.relaunch = function () {
    ...
    WrapperProcess.prototype.start = function () {
        ...
        if (!this.started) {
            this.started = this.spawn().then(function (child) {
                ...
                if (child.stdout) {
                    child.stdout.pipe(_this.logStdoutStream);
                    child.stdout.pipe(process.stdout);
                }
                if (child.stderr) {
                    child.stderr.pipe(_this.logStderrStream);
