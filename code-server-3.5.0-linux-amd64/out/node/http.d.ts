...
export declare abstract class HttpProvider {
     ...
     */
    protected replaceTemplates<T extends object>(route: Route, response: HttpStringFileResponse, extraOptions?: Omit<T, "base" | "csStaticBase" | "logLevel">): HttpStringFileResponse;
...
export declare class HttpServer {
    ...
    registerHttpProvider<A1, T extends HttpProvider>(endpoint: string | string[], provider: HttpProvider1<A1, T>, a1: A1): T;
    registerHttpProvider<A1, A2, T extends HttpProvider>(endpoint: string | string[], provider: HttpProvider2<A1, A2, T>, a1: A1, a2: A2): T;
    registerHttpProvider<A1, A2, A3, T extends HttpProvider>(endpoint: string | string[], provider: HttpProvider3<A1, A2, A3, T>, a1: A1, a2: A2, a3: A3): T;
    /**
